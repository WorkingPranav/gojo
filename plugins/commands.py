...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/+rGv-g-br27dhZGQ9"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movies Updates ⚡', url=f"https://telegram.me/+rGv-g-br27dhZGQ9")
            ],[
             InlineKeyboardButton('🙆🏻 Help 🦾', url='https://telegram.me/Good_Down'),
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movies Update ⚡', url=f"https://telegram.me/+rGv-g-br27dhZGQ9")
            ],[
             InlineKeyboardButton('🙆🏻 Help 🦾', url='https://telegram.me/Good_Down'),
            InlineKeyboardButton('♥️ About ♥️', callback_data='about')
        ]]
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('Official Channel', url='https://telegram.me/trexofficials')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
